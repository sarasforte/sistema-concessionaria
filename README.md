...
Desenvolver um sistema de gerenciamento de concessionária que permita o controle de clientes, automóveis, vendedores e vendas por meio de operações CRUD e banco de dados relacional.
